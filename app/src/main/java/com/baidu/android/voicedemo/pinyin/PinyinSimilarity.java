...
package com.baidu.android.voicedemo.pinyin;
	...
	public String changeWordProcessEnglish(String strInput){
 	...
 	public String changeOneWord(String strInput){
 	    ...
 	    if(numberString.contains(strInput)){
 	        int index = numberString.indexOf(strInput);
 	        return numberStringArabic.substring(index,index+1);
        }

 		return changeWord(strInput);
 	}
 ...
 */ 	
    private String changeWord(String strInput) {
